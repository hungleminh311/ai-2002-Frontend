        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              ...
              >
                Revolutionizing Engineering with Gamble
              </h2>
              <p
              ...
              >
                Unleash innovation and efficiency with our cutting-edge development solutions. Ready to take your project to the next level?
              </p>
            </div>
            <dl
